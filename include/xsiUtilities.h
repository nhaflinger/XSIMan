...
void getMatrixParameter(Parameter param, float vec3[16]);
...
CValue GetApproximatedMeshAndAttributes(PolygonMesh polymesh, long subdivisionRule, long subdivisionLevel, bool discontinuity, double discontinuityAngle);
